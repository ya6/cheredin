...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/admin/takepart/1">HOME Take part</a></li>
...
<div class=" container ">
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        ...
        <div style="max-width:400px;  border:1px solid #ccc;">
            <img src="/images/takepart/{{ $takepart->image }}" alt="@lang('image preview')" width="100%" id="slide"></a>
        </div>
        <br>
        ...
        <hr>
        <form class="needs-validation" method="post" action='/admin/takepart/{{ $takepart->id }}' enctype="multipart/form-data">
            @csrf
            @method('PATCH')
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        <div class=" form-group ">
            ...
            <input id="my-input" class="form-control" type="text" name="title_en" value="{{ $takepart->title_en }}">
        </div>
        <div class="form-group ">
            <label for="my-textarea">@lang('Description') @lang('English')</label>
            <textarea id="my-textarea" class="form-control" name="description_en" rows="3">{{ $takepart->description_en }}</textarea>
        </div>
    </div>
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        <div class="form-group ">
            ...
            <input id="my-input" class="form-control" type="text" name="title_ru" value="{{ $takepart->title_ru }}">
        </div>
        <div class="form-group">
            <label for="my-textarea">@lang('Description') @lang('Russian')</label>
            <textarea id="my-textarea" class="form-control" name="description_ru" rows="3">{{ $takepart->description_ru }}</textarea>
        </div>
    </div>
