...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/admin/workout">HOME Workout</a></li>
...
<div class=" container ">
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        ...
        <hr>
        <form class="needs-validation" method="post" action='/admin/workout' enctype="multipart/form-data">
            @csrf
