...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/admin/home_about/1">HOME About</a></li>
...
<div class=" container ">
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        ...
        <div style="max-width:400px;  border:1px solid #ccc;">
            <img src="/images/home_about/{{ $home_about->image }}" alt="@lang('image preview')" width="100%" id="slide"></a>
        </div>
        <br>
        ...
        <hr>
        <form class="needs-validation" method="post" action='/admin/home_about/{{ $home_about->id }}' enctype="multipart/form-data">
            @csrf
            @method('PATCH')
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        <div class=" form-group ">
            ...
            <input id="my-input" class="form-control" type="text" name="title_en" value="{{ $home_about->title_en }}">
        </div>
        <div class="form-group ">
            <label for="my-textarea">@lang('Description') @lang('English')</label>
            <textarea id="my-textarea" class="form-control" name="description_en" rows="3">{{ $home_about->description_en }}</textarea>
        </div>
    </div>
    ...
    <div class="mt-3 p-3 bg-light col-md-6">
        <div class="form-group ">
            ...
            <input id="my-input" class="form-control" type="text" name="title_ru" value="{{ $home_about->title_ru }}">
        </div>
        <div class="form-group">
            <label for="my-textarea">@lang('Description') @lang('Russian')</label>
            <textarea id="my-textarea" class="form-control" name="description_ru" rows="3">{{ $home_about->description_ru }}</textarea>
        </div>
    </div>
