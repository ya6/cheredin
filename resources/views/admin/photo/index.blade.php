    ...
    <div class="row p-3" style="b order: 1px solid green">
        ...
        <div class="col" style="b order: 1px solid gray">
            <img name="slide" class=" mt-1 mr-3" style="border: 1px solid gray"
                src="/images/photos/{{ $photo->image }}" alt="photo" width="300">
        </div>
<div class="col  p-2">
    ...
    <div class="col  p-2 " style="b order: 1px solid green">
        <div class="row">
            <div class="">
                <a href=" /admin/photo/{{$photo->id}}/edit " class="btn btn-primary  text-light mr-5">@lang('Edit')</a>
            </div>
...
<div class=" row">
    <a href="/admin/photo/create" class="btn btn-primary w-100 m-2">@lang('Add new')</a>
</div>
<br>
</div>
@endsection
