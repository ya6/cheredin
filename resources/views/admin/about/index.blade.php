...
<div class="row p-3" style="b order: 1px solid green">
    ...
    <div class="col" style="b order: 1px solid gray">
        <img name="slide" class=" mt-1 mr-3" style="border: 1px solid gray"
            src="/images/about/{{ $about->image }}" alt="about photo" width="400">
    </div>
<div class="col p-2">
    <div class="card m-1" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush">
            ...
            <p class="h6">{{$about->title_en}}</p>   
            </li>
            <li class="list-group-item"><u>@lang('Description'):</u>
            <p class="h6">{{$about->description_en}}</p>   
            </li>
        </ul>
    </div>
    ...
    <div class="card m-1" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item"> <u>@lang('Title'):</u>
            <p class="h6">{{$about->title_ru}}</p>   
            </li>
            <li class="list-group-item"><u>@lang('Description'):</u>
            <p class="h6">{{$about->description_ru}}</p>   
            </li>
        </ul>
    </div>
...
<div class="col  ml-4 p-2 " style="b order: 1px solid green">
    <div class="row">
        <div class="">
            <a href=" /admin/about/{{$about->id}}/edit " class="btn btn-primary  text-light mr-5">@lang('Edit')</a>
        </div>
